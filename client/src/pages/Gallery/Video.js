        ...
        <div className='video_parent'>
            <div className='video_parent_div'>
                ...
                <div className='video_one_div'>
                    ...
                    <div className='youtube_div'>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/lGSGTrn5INA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
